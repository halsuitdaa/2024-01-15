                    ...
                    <div class="col-lg-6 col-xl-4">
                        <div class="p-4 rounded bg-light">
                            <div class="row align-items-center">
                                ...
                                <div class="col-6">
                                    <a href="../recipe/detail.do?no=${vo.no }" class="h5"><p>${vo.title }</p></a>
                                    ...
                                    <a href="../recipe/detail.do?no=${vo.no }" class="btn border rounded-pill px-3 text-primary"> ${vo.difficulty }</a>
                                </div>
                            </div>
                        </div>
                    </div>
