...
$(document).ready(function() {
    ...
    $("#listButton").click(function() {
        ...
        if (currentPage.includes("new")) {
            keyword = "new";
        } else if (currentPage.includes("long")) {
            keyword = "long";
        } else if (currentPage.includes("backpacking")) {
            keyword = "backpacking";
        ...
        // 적절한 키워드로 페이지 이동
        if (keyword !== "") {
            window.location.href = "../store/" + keyword + ".do?page=${listcurpage}";
        }
    });
});
</script>
